                             ...
                             out _)))
        {
            try
            {
                ...
                var mutation = await client.SendCommandAsync(
                    ...
                    {
                        expression =
                            "(()=>{const b=document.body;if(!b)return false;b.setAttribute('data-mycodex-probe','true');const installed=b.getAttribute('data-mycodex-probe')==='true';b.removeAttribute('data-mycodex-probe');return installed&&!b.hasAttribute('data-mycodex-probe');})()",
                        returnByValue = true
                    },
                    cancellationToken: cancellationToken).ConfigureAwait(false);
