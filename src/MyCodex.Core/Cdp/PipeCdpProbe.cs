                     ...
                     candidate.Type is "page" or "webview"))
        {
            try
            {
                ...
                var mutation = await client.SendCommandAsync(
                    ...
                    {
                        expression =
                            "(()=>{const b=document.body;if(!b)return false;b.dataset.mycodexPipeProbe='true';const ok=b.dataset.mycodexPipeProbe==='true';delete b.dataset.mycodexPipeProbe;return ok})()",
                        returnByValue = true
                    },
                    cancellationToken: cancellationToken).ConfigureAwait(false);
